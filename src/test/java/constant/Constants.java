...
public class Constants {
    ...
    public static final String ISSUE_ENDPOINT = "/rest/api/3/issue/%s";

    public static final String SEARCH_ENDPOINT = "/rest/api/3/search?jql=project=%s&maxResults=1000";
    public static final String TEMPLATE_DIRECTORY = StringUtils.getCurrentDir() + "src/test/resources/template/template.json";
    public static final String QA_TEMPLATE_DIRECTORY = StringUtils.getCurrentDir() + "src/test/resources/template/qa_template.json";
